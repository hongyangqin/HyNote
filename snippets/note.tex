...
ls|grep iprange-|xargs -n1 -i mv {} {}.conf
    ...
    \begin{texcode}
https://script.google.com/macros/s/AKfycbxlF_0HvkB8vn7K8HtzUps4wjK0UamE1qJFaIgNhIjAZ-jAjLk/exec?mid=221648
...
function doGet(request) {
  ...
  +'<title type="text">华南理工大学教务处-教务通知</title>'
  +'<link href="http://jwc.scuteo.com/jiaowuchu/cms/index.do" rel="alternate"/>'
  +'<id>http://jwc.scuteo.com/jiaowuchu/cms/index.do</id>'
...
//  Logger.log(data)
  ...
  data.forEach(function(e) {
     ...
     +'<updated>'+ e.createTime.slice(0,10) + 'T'  + e.createTime.slice(11,19) + 'Z' +'</updated>'
     +'<id>http://jwc.scuteo.com/jiaowuchu'+e.href+'</id>'
     +'</entry>'
  })
  ...
  return ContentService.createTextOutput(feed)
    .setMimeType(ContentService.MimeType.RSS);
        ...
        注:写完之后在\url{http://www.feedvalidator.org/}检验
